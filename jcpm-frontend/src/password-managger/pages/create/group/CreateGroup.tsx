    ...
    <form onSubmit={onSubmitForm} className="create-group">
      <div className="create-group-contanier">
        <div className="create-top-buttons">
          ...
          <button type="submit" disabled={isSavinGroup} style={{ marginLeft: "1rem" }}>Save</button>
        </div>
        <div>
        ...
        <input
          ...
          className={`input-group-name ${isSubmitted && errorMessages.errorTitleGroup ? "input-error" : ""}`}
        />
        {isSubmitted && errorMessages.errorTitleGroup && (
